...
for (let usersListElement of usersList) {
    ...
    divBlock.style.margin = '30px';
    divBlock.style.padding = '10px 20px';
    ...
    divEmail.innerText = usersListElement.email;
        ...
        divAddress.style.border = '1px solid black';
        divAddress.style.margin = '10px';
        divAddress.style.padding = '3px 7px';
        let divStreet = document.createElement('div');
        divStreet.innerText = usersListElement.address.street;
        let divSuite = document.createElement('div');
        divSuite.innerText = usersListElement.address.suite;
        let divCity = document.createElement('div');
        divCity.innerText = usersListElement.address.city;
        let divZip = document.createElement('div');
        divZip.innerText = usersListElement.address.zipcode;
